...
public class Vehicle {
    ...
    public Vehicle(Long id, String name, String plateNumber, String status, String type, float fuelCapacity, float carryingWeight, float totalWeight, List<Item> items) {
        this.version = 0L;
        this.id = id;
        this.name = name;
